...
public class JavaScriptUtil {
	...
	//6.Sendkeys with Name
		public void senKeysWithNamebyJS(WebDriver driver,String name,String value) {
					JavascriptExecutor js = (JavascriptExecutor)driver;
	...
	//10.Scroll to a particular element
	...
	//11.Flash/highlight a specific element
